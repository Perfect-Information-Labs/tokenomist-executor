/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: e7437d6105fc1f905cb5c9e564a5eb0a)
...
interface __BaseEnv_CloudflareBindings {
	...
	USDC_ADDRESS: string;
	TOKENOMIST_CONTRACT_ADDRESS: string;
	GATEWAY_FACILITATOR_URL: string;
	ARC_TESTNET_RPC_URL: string;
	ARC_NETWORK_ID: string;
	RATE_LIMITER_WRITE: RateLimit;
	RATE_LIMITER_READ: RateLimit;
	RATE_LIMITER_TIER_DETAILS: RateLimit;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SELLER_ADDRESS" | "GATEWAY_WALLET_ADDRESS" | "USDC_ADDRESS" | "TOKENOMIST_CONTRACT_ADDRESS" | "GATEWAY_FACILITATOR_URL" | "ARC_TESTNET_RPC_URL" | "ARC_NETWORK_ID">> {}
}
